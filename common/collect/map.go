...
func NewIntMap[V any]() ConcurrentMap[int, V] {
	return create[int, V](intfnv32)
}

func NewUInt32Map[V any]() ConcurrentMap[uint32, V] {
	return create[uint32, V](uintf)
}
func NewStrMap[V any]() ConcurrentMap[string, V] {
...
func NewWithCustomShardingFunctionMap[K comparable, V any](sharding func(key K) uint32) ConcurrentMap[K, V] {
...
func intfnv32(key int) uint32 {
	return fnv32(strconv.Itoa(key))
}

func uintf(key uint32) uint32 {
	return key
}
